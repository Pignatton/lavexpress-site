...
export const metadata: Metadata = {
    title: "Lavagem de Edredons e Cobertores | Lavexpress",
    description:
        "Lavagem e secagem completa de edredons e cobertores com padrão profissional: mais volume, maciez e sensação de limpeza. Coleta e entrega em Vitória/ES.",
};

const STARTING_PRICE = 40; // ✅ a partir de R$ 40,00
...
export default function EdredonsPage() {
    const waAgendar = buildWhatsAppLink({
        phoneE164: LAVEXPRESS.whatsappE164,
        text:
            "Olá! Quero lavar edredom/cobertor. Pode me informar coleta/entrega e o valor? (Tamanho: ___ / Quantidade: ___ / Bairro: ___)",
    });

    const waDuvidas = buildWhatsAppLink({
        phoneE164: LAVEXPRESS.whatsappE164,
        text:
            "Olá! Tenho dúvidas sobre lavagem de edredons (prazo, tamanho e valor). Pode me orientar?",
    });
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-4 md:mb-6 leading-tight text-balance">
                                    ...
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-600">
                                        maciez, volume e cheiro de limpo
                                    </span>{" "}
                                    — sem dor de cabeça.
                                </h1>

                                <p className="text-base md:text-lg lg:text-xl text-slate-600 mb-6 md:mb-8 leading-relaxed text-pretty">
                                    Lavagem e secagem <strong>com padrão profissional</strong> para peças volumosas.
                                    A Lavexpress busca, higieniza e entrega pronto para você guardar ou usar.
                                </p>
                                ...
                                <div className="flex flex-wrap items-center gap-3 mb-6">
                                    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-extrabold text-slate-900 shadow-sm">
                                        ...
                                        <span className="text-blue-600">R$ {formatBRL(STARTING_PRICE)}</span>
                                    </div>
                                    <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-extrabold text-blue-700 shadow-sm">
                                        ...
                                        Secagem completa (sem cheiro de umidade)
                                    </div>
                                ...
                                <div className="grid gap-3 mb-6 md:mb-8">
                                    <div className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                                        ...
                                        <div>
                                            <div className="font-extrabold text-slate-900">Lavagem profunda para peças volumosas</div>
                                            <div className="text-sm text-slate-600">
                                                Tratamento adequado para tecido e enchimento — limpa sem &quot;massacrar&quot; a peça.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                                        ...
                                        <div>
                                            <div className="font-extrabold text-slate-900">Secagem completa + volume de volta</div>
                                            <div className="text-sm text-slate-600">
                                                Secagem controlada para evitar cheiro de umidade e devolver o &quot;fofinho&quot; do edredom.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                                        ...
                                        <div>
                                            <div className="font-extrabold text-slate-900">Pronto para guardar ou usar</div>
                                            <div className="text-sm text-slate-600">
                                                Entrega organizada e protegida para manter a sensação de &quot;acabou de lavar&quot;.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 flex flex-wrap items-center gap-3">
                                    ...
                                    <Pill>Secagem completa</Pill>
                                </div>

                                <p className="mt-4 text-xs text-slate-500">
                                    Observação: valor final varia por tamanho (solteiro/casal/queen/king), tipo e quantidade. Confirmamos no WhatsApp antes de fechar.
                                </p>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative rounded-[2rem] overflow-hidden border border-white/60 shadow-2xl bg-white/80 backdrop-blur-sm">
                                    <Image
                                        src="/images/edredom_hero_clean_1767392053952.png"
                                        alt="Edredom higienizado e volumoso"
                                        width={800}
                                        height={600}
                                    ...
                                    {/* Price Tag Overlay */}
                                    <div className="absolute bottom-3 right-3 md:bottom-6 md:right-6 bg-white/95 backdrop-blur rounded-xl md:rounded-2xl p-3 md:p-4 shadow-xl border border-slate-100 max-w-[190px] md:max-w-[260px]">
                                        ...
                                        <div className="mt-1.5 md:mt-2 text-[10px] md:text-xs text-slate-600 font-semibold leading-tight">
                                            Valor varia por tamanho/tipo/quantidade.
                                        </div>
                                        <div className="mt-2 md:mt-3 text-[10px] md:text-xs text-emerald-700 font-extrabold flex items-center gap-1">
                                            <CheckCircle2 className="h-3 w-3" />
                                            <span className="hidden md:inline">Secagem completa (sem cheiro de umidade)</span>
                                            <span className="md:hidden">Secagem completa</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    {[
                                        { title: "Lavagem", desc: "padrão profissional" },
                                        { title: "Secagem", desc: "completa e controlada" },
                                        { title: "Finalização", desc: "pronto p/ guardar" },
                                    ].map((it) => (
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            ...
                            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-3 md:mb-4">
                                Porque edredom exige máquina grande e secagem completa
                            </h2>
                            <p className="text-slate-600 leading-relaxed">
                                Em casa, o &quot;problema&quot; não é lavar — é <strong>secar 100%</strong>. É a secagem completa que evita cheiro de umidade e deixa a peça realmente pronta.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
                            <Card className="p-6 md:p-8 rounded-2xl md:rounded-3xl border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-lg transition-all group">
                                ...
                                <h3 className="text-xl font-extrabold text-slate-900 mb-3">Higiene de verdade</h3>
                                <p className="text-slate-600 leading-relaxed">
                                    Limpeza profunda com padrão profissional para peças volumosas, sem improviso.
                                </p>
                            </Card>
                            ...
                            <Card className="p-6 md:p-8 rounded-2xl md:rounded-3xl border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-lg transition-all group">
                                ...
                                <h3 className="text-xl font-extrabold text-slate-900 mb-3">Mais maciez e volume</h3>
                                <p className="text-slate-600 leading-relaxed">
                                    Secagem controlada para devolver o &quot;fofinho&quot; e a sensação gostosa ao toque.
                                </p>
                            </Card>
                            ...
                            <Card className="p-6 md:p-8 rounded-2xl md:rounded-3xl border-slate-100 bg-slate-50/50 hover:bg-white hover:shadow-lg transition-all group">
                                ...
                                <h3 className="text-xl font-extrabold text-slate-900 mb-3">Sem cheiro de umidade</h3>
                                <p className="text-slate-600 leading-relaxed">
                                    O diferencial é secar por completo — peça pronta para guardar sem preocupação.
                                </p>
                            </Card>
                        </div>
                    </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                            <div>
                                ...
                                <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-4 md:mb-6">
                                    Como funciona (rápido e organizado)
                                </h2>
                                ...
                                <div className="space-y-6">
                                    {[
                                        {
                                            title: "1) Coleta",
                                            desc: "A gente busca na sua casa (ou você entrega na loja).",
                                        },
                                        {
                                            title: "2) Identificação do tipo/tamanho",
                                            desc: "Confirmamos tamanho e tipo para aplicar o tratamento adequado.",
                                        },
                                        {
                                            title: "3) Lavagem + secagem completa",
                                            desc: "Limpa e seca com padrão profissional para devolver conforto e maciez.",
                                        },
                                        {
                                            title: "4) Entrega protegida",
                                            desc: "Entregamos de forma organizada para manter a peça pronta para uso/guarda.",
                                        },
                                    ].map((step, i) => (
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Card className="p-6 bg-white border-slate-100 shadow-sm rounded-2xl">
                                    ...
                                    <div className="text-3xl font-extrabold text-slate-900 mb-1">2–3 dias</div>
                                    <div className="text-sm text-slate-500 font-medium">
                                        Para garantir secagem completa.
                                    </div>
                                </Card>
                                ...
                                <Card className="p-6 bg-white border-slate-100 shadow-sm rounded-2xl">
                                    ...
                                    <div className="text-3xl font-extrabold text-slate-900 mb-1">Todos</div>
                                    <div className="text-sm text-slate-500 font-medium">
                ...
                <section className="py-12 md:py-16 bg-white border-t border-slate-100">
                    <div className="container mx-auto px-4 md:px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
                            {[
                                {
                                    q: "Lavam edredom King/Queen?",
                                    a: "Sim. Nossas máquinas atendem todos os tamanhos (solteiro, casal, queen e king).",
                                },
                                {
                                    q: "Quanto tempo leva?",
                                    a: "Em média 2 a 3 dias úteis para garantir secagem completa. Confirmamos o prazo no WhatsApp antes de fechar.",
                                },
                                {
                                    q: "Vocês buscam e entregam?",
                                    a: "Sim. A coleta e entrega dependem da área atendida — confirmamos rapidinho pelo seu bairro/CEP.",
                                },
                                {
                                    q: "Qual o valor?",
                                    a: `A partir de R$ ${formatBRL(STARTING_PRICE)}. O valor varia conforme tamanho, tipo (edredom/cobertor) e quantidade. Confirmamos antes de finalizar.`,
                                },
                            ].map((item) => (
